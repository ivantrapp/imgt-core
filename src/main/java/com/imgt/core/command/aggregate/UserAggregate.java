...
import com.imgt.core.command.domain.user.event.UserAddAddress;
import com.imgt.core.command.domain.user.event.UserCreated;
import com.imgt.core.command.domain.user.event.UserRemoveAddress;
import com.imgt.core.command.domain.user.event.UserUpdated;
